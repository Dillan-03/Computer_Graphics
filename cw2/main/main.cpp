...
#	endif // ~ !NDEBUG
	...
	// Vec3f groundCameraPosition = {0.0f, 0.0f, 0.0f}; // Start with an initial position

	// 	// Modify the position as needed and print itcc  cccccr
	// 	for (int i = 0; i < 10; ++i) {
	// 		groundCameraPosition.x = i; // Increment x-coordinate
    //     groundCameraPosition.y = i / 2.0f; // Change y-coordinate
    //     groundCameraPosition.z = i / 3.0f; // Change z-coordinate

    //     // Output the current position
    //     std::cout << "Ground Camera Position: "
    //               << "X: " << groundCameraPosition.x
    //               << ", Y: " << groundCameraPosition.y
    //               << ", Z: " << groundCameraPosition.z << std::endl;
