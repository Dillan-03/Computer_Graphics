...
#	endif // ~ !NDEBUG
	...
	if (state.thrust) {
		...
		Vec3f cameraPos2Pad  = {10.0f, -.0f, 0.0f};
		...
		Vec3f lightColor1 = {1.0f, 2.95f, 0.9f}; // Soft white light
  
		Vec3f lightColor2 = {1.0f, 0.6f, 2.3f}; // Warm orange light
 
		Vec3f lightColor3 = {2.3f, 0.5f, 1.0f}; // Cool blue light
 
		Vec3f cameraPos1 = {0.0f, 0.0f, 5.0f};
		Vec3f cameraPos2  = {5.0f, 0.0f, 0.0f};
		Vec3f cameraPos3  = {0.0f, 5.0f, -5.0f};
		...
		glUniform3f( 11, 0.05, 0.2, 0.1); //Light Diffuse
